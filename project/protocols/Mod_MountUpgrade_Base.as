package com.protocols
{
    ...
    public class Mod_MountUpgrade_Base extends Object
    {
        ...
        public static const ID_ERROR:int = 14;
        public static const get_info:Object = {module:265, action:0, request:[Utils.UByteUtil], response:[Utils.UByteUtil, [Utils.UByteUtil, Utils.ShortUtil, Utils.ShortUtil, Utils.ByteUtil], Utils.UByteUtil, Utils.ShortUtil, Utils.IntUtil]};
        public static const active_rune_point:Object = {module:265, action:1, request:[Utils.UByteUtil, Utils.UByteUtil], response:[Utils.UByteUtil, Utils.ShortUtil, Utils.ByteUtil, Utils.IntUtil]};
        ...
        public static const get_guard_list:Object = {module:265, action:5, request:[], response:[[Utils.UByteUtil, Utils.ByteUtil, Utils.IntUtil, Utils.IntUtil]]};
        public static const equip_guard:Object = {module:265, action:6, request:[Utils.UByteUtil, Utils.ByteUtil, Utils.IntUtil], response:[Utils.UByteUtil]};
        public static const Actions:Array = ["get_info", "active_rune_point", "upgrade_rune_skill", "active_rune_skill", "set_is_show_rune", "get_guard_list", "equip_guard"];
